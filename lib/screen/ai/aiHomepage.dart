...
class AIPageHomepage extends StatefulWidget {
  const AIPageHomepage({super.key});

  @override
  State<AIPageHomepage> createState() => _AIPageHomepageState();
}

class _AIPageHomepageState extends State<AIPageHomepage> {
  ...
  Future<void> _loadMessages() async {
    ...
    final String? cachedMessages = prefs.getString('chat_history_homepage');
  ...
  Future<void> _saveMessages() async {
    ...
    await prefs.setString('chat_history_homepage', jsonMessages);
  }
  ...
  void _clearMessages() async {
    final prefs = await SharedPreferences.getInstance();
    await prefs.remove('chat_history_homepage'); // Clear stored messages
